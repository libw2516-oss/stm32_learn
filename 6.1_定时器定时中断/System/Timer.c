...
void Timer_Init(void)
{
	...
	TIM_InternalClockConfig(TIM2);//第二步设置定时器2时钟为内部时钟
	...
	TIM_TimeBaseStructure.TIM_Period = 7200 - 1;//自动重装载值ARR，7200下自动重装
	TIM_TimeBaseStructure.TIM_Prescaler = 10000 - 1;//设置预分频器PCC，降低频率为7200Hz
